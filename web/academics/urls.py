...
urlpatterns = [
    ...
    path('departments/import/', imports.department_import, name='department_import'),
    ...
    path('teachers/import/', imports.teacher_import, name='teacher_import'),
    ...
    path('students/import/', imports.student_import, name='student_import'),
    ...
    path('import-template/<str:kind>/', imports.download_template, name='import_template'),
